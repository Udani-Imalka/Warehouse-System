                ...
                <div className="col-lg-12">
                  <div className="card">
                    <div className="card-body">
                      <h4 className="card-title mb-4">GRN List</h4>
                ...
                <a href="/#" class="btn btn-primary waves-effect waves-light">Add Product</a>
                      ...
                      <div className="row">
                        <div className="col-xl-10">
                          {/* <button type="button" className="btn btn-success waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#exampleModalFullscreen"></button> */}
                        </div>
                        <div class="col-xl-2">
                        ...
                        <table className="table align-middle table-nowrap mb-0">
                          <thead className="table-light">
                            <tr>
                              ...
                              <th className="align-middle">grnDate</th>
