...
export default class GRNcart extends Component {
  render() {
    return (
                ...
                <div className="col-lg-12">
                  <div className="card">
                    <div className="card-body">
                      <h4 className="card-title mb-4">GRN CART List</h4>
                        ...
                        <table className="table align-middle table-nowrap mb-0">
                          <thead className="table-light">
                            <tr>
                              ...
                              <th className="align-middle">grnCartID</th>
                              <th className="align-middle">recId</th>
